function surf2stl_V1(filename,x,y,z,mode)
...
%
% JH 8/2/2018 -- This STL generator requires that the layers have the same
% number of points.  So far, this seems to be the only limitation.  Option
% 2 seems to be the most appropriate use of this function for our purposes.
