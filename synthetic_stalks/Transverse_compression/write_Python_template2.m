% write_Python_template2.m: Use Christopher's Python script for taking
% cross-section points and running an Abaqus case and make a string array
% that can be used to

% THIS IS USED TO ALLOW MULTIPLE LICENSES TO BE USED AT THE SAME TIME
