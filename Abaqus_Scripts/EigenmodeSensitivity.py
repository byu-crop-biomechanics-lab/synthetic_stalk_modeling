...
stalknumber = 'CT-4401-S9'
E_rind = 13230.0



#set model names: first run baseline model (BASE), then vary elastic moduli (E1 & E3) and shear moduli (G12 & G13) for the rind (R) and pith (P)
models = ['BASE', 'R_E1', 'R_E3', 'R_G12', 'R_G13', 'P_E1', 'P_E3', 'P_G12', 'P_G13']
